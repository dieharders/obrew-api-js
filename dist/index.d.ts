...
interface I_DownloadMmprojRequest {
    repo_id: string;
    filename: string;
    model_repo_id: string;
}
interface I_DownloadMmprojResponse {
    repoId: string;
    mmprojPath: string;
    size: number;
}
...
interface I_ServiceApis extends I_BaseServiceApis {
    ...
    vision: {
        ...
        downloadMmproj: T_GenericAPIRequest<I_DownloadMmprojRequest, I_DownloadMmprojResponse>;
...
declare class ObrewClient {
    ...
    downloadMmproj(repoId: string, filename: string, modelRepoId: string): Promise<I_DownloadMmprojResponse>;
