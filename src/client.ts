...
class ObrewClient {
   ...
   * @throws Error if not connected or search fails
   */
  async webSearch(options: I_WebSearchRequest): Promise<I_SearchResponse> {
    if (!this.isConnected()) {
      throw new Error('Not connected to Obrew service')
    }
  ...
  async fileSystemSearch(
    options: I_FileSystemSearchRequest
  ): Promise<I_SearchResponse> {
    if (!this.isConnected()) {
      throw new Error('Not connected to Obrew service')
    }
  ...
  async structuredSearch(
    options: I_StructuredSearchRequest
  ): Promise<I_SearchResponse> {
    if (!this.isConnected()) {
      throw new Error('Not connected to Obrew service')
    }
